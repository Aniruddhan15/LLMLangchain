...
print(chain.invoke({'key': ['Chat! What is my schedule next monday on raw??']}).content)


response11= chain.invoke({'key': 
    [
        HumanMessage(content='Wiseman, am i qualified for MITB contention?')
    ]})
